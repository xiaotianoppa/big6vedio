...
(function(window, undefined) {
  ...
  if(active){
	...
	$("#commentsBackground").addClass("active");
	...
	$('.highlight,#top-bar-hide,#comments-separator1').css('opacity','0');
	$(".comments-separator").not("#comments-separator1").css('background-color','#FFFFFF');
	$("#scenarioName").css('color','#FFFFFF');
	$("#canvasname").css('color', '#000000');
	$('#gestureTool').prop('disabled', 'disabled');
	$('#highlight-select,#top-bar-hide').css('cursor', 'default');
  ...
  else if ($(".ui-scenario").length <= 0) {
	jimComments.commentsMode = false;
	
	if(tutorial)
	  $tutorial.hide();
  
	$("#commentsBackground").removeClass("active");
	...
	$('.highlight,#top-bar-hide,#comments-separator1').css('opacity','1');
	$(".comments-separator").not("#comments-separator1").css('background-color','');
	$("#scenarioName").css('color','');
	$("#canvasname").css('color', '');
	$('#gestureTool').prop('disabled', false);
	$('#highlight-select,#top-bar-hide').css('cursor', '');
